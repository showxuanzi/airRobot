    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>添加赛事报名</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container" v-loading="loading" 
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="80px" class="news-form">
                ...
                <el-form-item label="赛事概述" prop="keyword">
        ...
        data: function(){
            return {
                ...
                rules: {
                    ...
                    keyword: [
                        { required: true, message: '请输入赛事概述', trigger: 'blur' }
                    ],
                    imgpath: [
                        { required: true, message: '请上传封面图片', trigger: 'change' }
                    ],
                    content: [
                        { required: true, message: '请输入比赛内容', trigger: 'blur' }
                    ]
                },
                selectOptions: [{
                    value: '分类1',
        ...
        methods: {
            ...
            submit(formName){
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.post(globalServerUrl+"/news/addnotice.do",Qs.stringify(this.form)
                        ).then((res)=>{
                            if(res.data == 1){
